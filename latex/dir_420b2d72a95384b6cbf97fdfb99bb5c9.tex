\doxysection{frontend/\+node\+\_\+modules/\+js-\/tokens Directory Reference}
\hypertarget{dir_420b2d72a95384b6cbf97fdfb99bb5c9}{}\label{dir_420b2d72a95384b6cbf97fdfb99bb5c9}\index{frontend/node\_modules/js-\/tokens Directory Reference@{frontend/node\_modules/js-\/tokens Directory Reference}}
...
\end{DoxyCode}
\hypertarget{dir_420b2d72a95384b6cbf97fdfb99bb5c9_autotoc_md2951}{}\doxysubsection{\texorpdfstring{Installation}{Installation}}\label{dir_420b2d72a95384b6cbf97fdfb99bb5c9_autotoc_md2951}
...
\end{DoxyCode}
\hypertarget{dir_420b2d72a95384b6cbf97fdfb99bb5c9_autotoc_md2952}{}\doxysubsection{\texorpdfstring{Usage}{Usage}}\label{dir_420b2d72a95384b6cbf97fdfb99bb5c9_autotoc_md2952}
\hypertarget{dir_420b2d72a95384b6cbf97fdfb99bb5c9_autotoc_md2953}{}\doxysubsubsubsection{\texorpdfstring{{\ttfamily js\+Tokens}}{{\ttfamily js\+Tokens}}}\label{dir_420b2d72a95384b6cbf97fdfb99bb5c9_autotoc_md2953}
...
The next match is always directly after the previous.\hypertarget{dir_420b2d72a95384b6cbf97fdfb99bb5c9_autotoc_md2954}{}\doxysubsubsubsection{\texorpdfstring{{\ttfamily var token = match\+To\+Token(match)}}{{\ttfamily var token = match\+To\+Token(match)}}}\label{dir_420b2d72a95384b6cbf97fdfb99bb5c9_autotoc_md2954}
...
Comments and strings both come in several flavors. To distinguish them, check if the token starts with {\ttfamily /\+/\+}, {\ttfamily /\+\texorpdfstring{$\ast$}{*}}, {\ttfamily \textquotesingle{}}, {\ttfamily "{}} or {\ttfamily  \`{} }.
...
Whitespace includes both line terminators and other whitespace.\hypertarget{dir_420b2d72a95384b6cbf97fdfb99bb5c9_autotoc_md2955}{}\doxysubsection{\texorpdfstring{ECMAScript support}{ECMAScript support}}\label{dir_420b2d72a95384b6cbf97fdfb99bb5c9_autotoc_md2955}
...
Currently, ECMAScript 2018 is supported.\hypertarget{dir_420b2d72a95384b6cbf97fdfb99bb5c9_autotoc_md2956}{}\doxysubsection{\texorpdfstring{Invalid code handling}{Invalid code handling}}\label{dir_420b2d72a95384b6cbf97fdfb99bb5c9_autotoc_md2956}
...
Invalid non-\/\+ASCII characters are treated as names, to simplify the matching of names (except unicode spaces which are treated as whitespace). Note:\+ See also the ES2018ES2018 section.
...
Strings may contain invalid escape sequences.\hypertarget{dir_420b2d72a95384b6cbf97fdfb99bb5c9_autotoc_md2957}{}\doxysubsection{\texorpdfstring{Limitations}{Limitations}}\label{dir_420b2d72a95384b6cbf97fdfb99bb5c9_autotoc_md2957}
Tokenizing Java\+Script using regexes—in fact, \+\_\+one single regex\+\_\+—won’t be perfect. But that’s not the point either.

You may compare js\+Tokens with \href{http://esprima.org/}{\texttt{esprima}} by using {\ttfamily esprima-\/compare.\+js}. See {\ttfamily npm run esprima-\/compare}!\hypertarget{dir_420b2d72a95384b6cbf97fdfb99bb5c9_autotoc_md2958}{}\doxysubsubsubsection{\texorpdfstring{Template string interpolation}{Template string interpolation}}\label{dir_420b2d72a95384b6cbf97fdfb99bb5c9_autotoc_md2958}
...
Matching template string interpolations requires recursive balancing of {\ttfamily \{} and {\ttfamily \}}—something that Java\+Script regexes cannot do. Only one level of nesting is supported.\hypertarget{dir_420b2d72a95384b6cbf97fdfb99bb5c9_autotoc_md2959}{}\doxysubsubsubsection{\texorpdfstring{Division and regex literals collision}{Division and regex literals collision}}\label{dir_420b2d72a95384b6cbf97fdfb99bb5c9_autotoc_md2959}
...
The above example is also correctly identified as division, because {\ttfamily e} is not a valid regex flag. I initially wanted to future-\/proof by allowing {\ttfamily \+[a-\/z\+A-\/Z]\+\texorpdfstring{$\ast$}{*}} (any letter) as flags, but it is not worth it since it increases the amount of ambigous cases. So only the standard {\ttfamily g}, {\ttfamily m}, {\ttfamily i}, {\ttfamily y} and {\ttfamily u} flags are allowed. This means that the above example will be identified as division as long as you don’t rename the {\ttfamily e} variable to some permutation of {\ttfamily gmiyus} 1 to 6 characters long.
...
\item Generally, if what looks like a regex literal is followed by an operator, the regex literal is treated as division instead. This is because regexes are seldomly used with operators (such as {\ttfamily +}, {\ttfamily \texorpdfstring{$\ast$}{*}}, {\ttfamily \&\&} and {\ttfamily ==}), but division could likely be part of such an expression.
\end{DoxyItemize}
...
If the end of a statement looks like a regex literal (even if it isn’t), it will be treated as one. Otherwise it should work as expected (if you write sane code).\hypertarget{dir_420b2d72a95384b6cbf97fdfb99bb5c9_autotoc_md2960}{}\doxysubsubsubsection{\texorpdfstring{ES2018}{ES2018}}\label{dir_420b2d72a95384b6cbf97fdfb99bb5c9_autotoc_md2960}
...
These things would be nice to do, but are not critical. They probably have to wait until the oldest maintained Node.\+js LTS release supports those features.\hypertarget{dir_420b2d72a95384b6cbf97fdfb99bb5c9_autotoc_md2961}{}\doxysubsection{\texorpdfstring{License}{License}}\label{dir_420b2d72a95384b6cbf97fdfb99bb5c9_autotoc_md2961}
\+[MIT]\+(LICENSE). 