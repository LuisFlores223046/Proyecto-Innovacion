\doxysection{frontend/\+node\+\_\+modules/\+set-\/cookie-\/parser Directory Reference}
\hypertarget{dir_b30980a05317b2a8803cebdbaab6a78e}{}\label{dir_b30980a05317b2a8803cebdbaab6a78e}\index{frontend/node\_modules/set-\/cookie-\/parser Directory Reference@{frontend/node\_modules/set-\/cookie-\/parser Directory Reference}}
\doxysubsubsection*{Directories}
\begin{DoxyCompactItemize}
\item 
directory \doxymbox{\hyperlink{dir_f9da548f43ee581711587791420613b1}{lib}}
\end{DoxyCompactItemize}


\doxysubsection{Detailed Description}
\hypertarget{dir_b30980a05317b2a8803cebdbaab6a78e_autotoc_md2546}{}\doxysubsection{\texorpdfstring{set-\/cookie-\/parser}{set-\/cookie-\/parser}}\label{dir_b30980a05317b2a8803cebdbaab6a78e_autotoc_md2546}
...
(The output format is loosely based on the input format of \href{https://www.npmjs.com/package/cookie}{\texttt{https:\+/\+/\+www.\+npmjs.\+com/\+package/\+cookie}})\hypertarget{dir_b30980a05317b2a8803cebdbaab6a78e_autotoc_md2549}{}\doxysubsection{\texorpdfstring{Install}{Install}}\label{dir_b30980a05317b2a8803cebdbaab6a78e_autotoc_md2549}

\begin{DoxyCode}{0}
\DoxyCodeLine{\$\ npm\ install\ -\/-\/save\ set-\/cookie-\/parser}

\end{DoxyCode}
\hypertarget{dir_b30980a05317b2a8803cebdbaab6a78e_autotoc_md2550}{}\doxysubsection{\texorpdfstring{Usage}{Usage}}\label{dir_b30980a05317b2a8803cebdbaab6a78e_autotoc_md2550}
\hypertarget{dir_b30980a05317b2a8803cebdbaab6a78e_autotoc_md2551}{}\doxysubsubsection{\texorpdfstring{Get array of cookie objects}{Get array of cookie objects}}\label{dir_b30980a05317b2a8803cebdbaab6a78e_autotoc_md2551}
...
\end{DoxyCode}
\hypertarget{dir_b30980a05317b2a8803cebdbaab6a78e_autotoc_md2552}{}\doxysubsubsection{\texorpdfstring{Get map of cookie objects}{Get map of cookie objects}}\label{dir_b30980a05317b2a8803cebdbaab6a78e_autotoc_md2552}
...
\end{DoxyCode}
\hypertarget{dir_b30980a05317b2a8803cebdbaab6a78e_autotoc_md2553}{}\doxysubsubsection{\texorpdfstring{Creating a new, modified set-\/cookie header}{Creating a new, modified set-\/cookie header}}\label{dir_b30980a05317b2a8803cebdbaab6a78e_autotoc_md2553}
...
See a real-\/world example of this in \href{https://github.com/nfriedly/node-unblocker/blob/08a89ec27274b46dcd80d0a324a59406f2bdad3d/lib/cookies.js\#L67-L85}{\texttt{unblocker}}\hypertarget{dir_b30980a05317b2a8803cebdbaab6a78e_autotoc_md2554}{}\doxysubsection{\texorpdfstring{Usage in React Native (and with some other fetch implementations)}{Usage in React Native (and with some other fetch implementations)}}\label{dir_b30980a05317b2a8803cebdbaab6a78e_autotoc_md2554}
...
Note that the {\ttfamily fetch()} spec now includes a {\ttfamily get\+Set\+Cookie()} method that provides un-\/combined {\ttfamily Set-\/\+Cookie} headers. This library will automatically use that method if it is present.\hypertarget{dir_b30980a05317b2a8803cebdbaab6a78e_autotoc_md2555}{}\doxysubsection{\texorpdfstring{API}{API}}\label{dir_b30980a05317b2a8803cebdbaab6a78e_autotoc_md2555}
\hypertarget{dir_b30980a05317b2a8803cebdbaab6a78e_autotoc_md2556}{}\doxysubsubsection{\texorpdfstring{parse(input, \+[options]\+)}{parse(input, \+[options]\+)}}\label{dir_b30980a05317b2a8803cebdbaab6a78e_autotoc_md2556}
Parses cookies from a string, array of strings, or a http response object. Always returns an array, regardless of input format. (Unless the {\ttfamily map} option is set, in which case it always returns an object.)\hypertarget{dir_b30980a05317b2a8803cebdbaab6a78e_autotoc_md2557}{}\doxysubsubsection{\texorpdfstring{parse\+String(individual\+Set\+Cookie\+Header, \+[options]\+)}{parse\+String(individual\+Set\+Cookie\+Header, \+[options]\+)}}\label{dir_b30980a05317b2a8803cebdbaab6a78e_autotoc_md2557}
Parses a single set-\/cookie header value string. Options default is {\ttfamily \{decode\+Values:\+ true\}}. Used under-\/the-\/hood by {\ttfamily parse()}. Returns an object.\hypertarget{dir_b30980a05317b2a8803cebdbaab6a78e_autotoc_md2558}{}\doxysubsubsection{\texorpdfstring{split\+Cookies\+String(combined\+Set\+Cookie\+Header)}{split\+Cookies\+String(combined\+Set\+Cookie\+Header)}}\label{dir_b30980a05317b2a8803cebdbaab6a78e_autotoc_md2558}
It\textquotesingle{}s uncommon, but the HTTP spec does allow for multiple of the same header to have their values combined (comma-\/separated) into a single header. This method splits apart a combined header without choking on commas that appear within a cookie\textquotesingle{}s value (or expiration date). Returns an array of strings that may be passed to {\ttfamily parse()}.\hypertarget{dir_b30980a05317b2a8803cebdbaab6a78e_autotoc_md2559}{}\doxysubsection{\texorpdfstring{References}{References}}\label{dir_b30980a05317b2a8803cebdbaab6a78e_autotoc_md2559}
...
\end{DoxyItemize}\hypertarget{dir_b30980a05317b2a8803cebdbaab6a78e_autotoc_md2560}{}\doxysubsection{\texorpdfstring{License}{License}}\label{dir_b30980a05317b2a8803cebdbaab6a78e_autotoc_md2560}
