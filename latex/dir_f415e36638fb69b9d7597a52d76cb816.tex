\doxysection{frontend/\+node\+\_\+modules/\+chokidar Directory Reference}
\hypertarget{dir_f415e36638fb69b9d7597a52d76cb816}{}\label{dir_f415e36638fb69b9d7597a52d76cb816}\index{frontend/node\_modules/chokidar Directory Reference@{frontend/node\_modules/chokidar Directory Reference}}
\doxysubsubsection*{Directories}
\begin{DoxyCompactItemize}
\item 
directory \doxymbox{\hyperlink{dir_c9b7f94d3d5cae8ab5ea4c644660b159}{lib}}
\end{DoxyCompactItemize}


\doxysubsection{Detailed Description}
\hypertarget{dir_f415e36638fb69b9d7597a52d76cb816_autotoc_md654}{}\doxysubsection{\texorpdfstring{Chokidar \+[!\+[Weekly downloads]\+(\href{https://img.shields.io/npm/dw/chokidar.svg}{\texttt{https:\+/\+/\+img.\+shields.\+io/\+npm/\+dw/\+chokidar.\+svg}})]\+(\href{https://github.com/paulmillr/chokidar}{\texttt{https:\+/\+/\+github.\+com/\+paulmillr/\+chokidar}}) \+[!\+[Yearly downloads]\+(\href{https://img.shields.io/npm/dy/chokidar.svg}{\texttt{https:\+/\+/\+img.\+shields.\+io/\+npm/\+dy/\+chokidar.\+svg}})]\+(\href{https://github.com/paulmillr/chokidar}{\texttt{https:\+/\+/\+github.\+com/\+paulmillr/\+chokidar}})}{Chokidar \+[!\+[Weekly downloads]\+(\href{https://img.shields.io/npm/dw/chokidar.svg}{\texttt{https:\+/\+/\+img.\+shields.\+io/\+npm/\+dw/\+chokidar.\+svg}})]\+(\href{https://github.com/paulmillr/chokidar}{\texttt{https:\+/\+/\+github.\+com/\+paulmillr/\+chokidar}}) \+[!\+[Yearly downloads]\+(\href{https://img.shields.io/npm/dy/chokidar.svg}{\texttt{https:\+/\+/\+img.\+shields.\+io/\+npm/\+dy/\+chokidar.\+svg}})]\+(\href{https://github.com/paulmillr/chokidar}{\texttt{https:\+/\+/\+github.\+com/\+paulmillr/\+chokidar}})}}\label{dir_f415e36638fb69b9d7597a52d76cb816_autotoc_md654}
\begin{quote}
Minimal and efficient cross-\/platform file watching library \end{quote}


\href{https://www.npmjs.com/package/chokidar}{\texttt{}}\hypertarget{dir_f415e36638fb69b9d7597a52d76cb816_autotoc_md655}{}\doxysubsection{\texorpdfstring{Why?}{Why?}}\label{dir_f415e36638fb69b9d7597a52d76cb816_autotoc_md655}
...
Version 3 is out! Check out our blog post about it:\+ \href{https://paulmillr.com/posts/chokidar-3-save-32tb-of-traffic/}{\texttt{Chokidar 3:\+ How to save 32TB of traffic every week}}\hypertarget{dir_f415e36638fb69b9d7597a52d76cb816_autotoc_md656}{}\doxysubsection{\texorpdfstring{How?}{How?}}\label{dir_f415e36638fb69b9d7597a52d76cb816_autotoc_md656}
...
\end{DoxyCode}
\hypertarget{dir_f415e36638fb69b9d7597a52d76cb816_autotoc_md658}{}\doxysubsection{\texorpdfstring{API}{API}}\label{dir_f415e36638fb69b9d7597a52d76cb816_autotoc_md658}
...
{\ttfamily chokidar.\+watch(paths, \+[options]\+)}
...
\end{DoxyItemize}\hypertarget{dir_f415e36638fb69b9d7597a52d76cb816_autotoc_md659}{}\doxysubsubsubsection{\texorpdfstring{Persistence}{Persistence}}\label{dir_f415e36638fb69b9d7597a52d76cb816_autotoc_md659}
...
\end{DoxyItemize}\hypertarget{dir_f415e36638fb69b9d7597a52d76cb816_autotoc_md660}{}\doxysubsubsubsection{\texorpdfstring{Path filtering}{Path filtering}}\label{dir_f415e36638fb69b9d7597a52d76cb816_autotoc_md660}
...
\end{DoxyItemize}\hypertarget{dir_f415e36638fb69b9d7597a52d76cb816_autotoc_md661}{}\doxysubsubsubsection{\texorpdfstring{Performance}{Performance}}\label{dir_f415e36638fb69b9d7597a52d76cb816_autotoc_md661}
...
\end{DoxyItemize}
\end{DoxyItemize}\hypertarget{dir_f415e36638fb69b9d7597a52d76cb816_autotoc_md662}{}\doxysubsubsubsection{\texorpdfstring{Errors}{Errors}}\label{dir_f415e36638fb69b9d7597a52d76cb816_autotoc_md662}
...
\end{DoxyItemize}\hypertarget{dir_f415e36638fb69b9d7597a52d76cb816_autotoc_md663}{}\doxysubsubsection{\texorpdfstring{Methods \& Events}{Methods \& Events}}\label{dir_f415e36638fb69b9d7597a52d76cb816_autotoc_md663}
...
\end{DoxyItemize}\hypertarget{dir_f415e36638fb69b9d7597a52d76cb816_autotoc_md664}{}\doxysubsection{\texorpdfstring{CLI}{CLI}}\label{dir_f415e36638fb69b9d7597a52d76cb816_autotoc_md664}
If you need a CLI interface for your file watching, check out \href{https://github.com/open-cli-tools/chokidar-cli}{\texttt{chokidar-\/cli}}, allowing you to execute a command on each change, or get a stdio stream of change events.\hypertarget{dir_f415e36638fb69b9d7597a52d76cb816_autotoc_md665}{}\doxysubsection{\texorpdfstring{Install Troubleshooting}{Install Troubleshooting}}\label{dir_f415e36638fb69b9d7597a52d76cb816_autotoc_md665}
...
\end{DoxyItemize}
\end{DoxyItemize}\hypertarget{dir_f415e36638fb69b9d7597a52d76cb816_autotoc_md666}{}\doxysubsection{\texorpdfstring{Changelog}{Changelog}}\label{dir_f415e36638fb69b9d7597a52d76cb816_autotoc_md666}
...
\end{DoxyItemize}\hypertarget{dir_f415e36638fb69b9d7597a52d76cb816_autotoc_md667}{}\doxysubsection{\texorpdfstring{Also}{Also}}\label{dir_f415e36638fb69b9d7597a52d76cb816_autotoc_md667}
Why was chokidar named this way? What\textquotesingle{}s the meaning behind it?

\texorpdfstring{$>$}{>}Chowkidar is a transliteration of a Hindi word meaning \textquotesingle{}watchman, gatekeeper\textquotesingle{}, चौकीदार. This ultimately comes from Sanskrit \+\_\+ चतुष्क\+\_\+ (crossway, quadrangle, consisting-\/of-\/four). This word is also used in other languages like Urdu as (چوکیدار) which is widely used in Pakistan and India.\hypertarget{dir_f415e36638fb69b9d7597a52d76cb816_autotoc_md668}{}\doxysubsection{\texorpdfstring{License}{License}}\label{dir_f415e36638fb69b9d7597a52d76cb816_autotoc_md668}
MIT (c) Paul Miller (\href{https://paulmillr.com}{\texttt{https:\+/\+/\+paulmillr.\+com}}), see \+[LICENSE]\+(LICENSE) file. 