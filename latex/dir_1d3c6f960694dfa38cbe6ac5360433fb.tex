...
\item 
directory \doxymbox{\hyperlink{dir_d63efa8b7cffbedd8b1ec263991dbbc0}{benchmarks}}
\end{DoxyCompactItemize}


\doxysubsection{Detailed Description}
\hypertarget{dir_1d3c6f960694dfa38cbe6ac5360433fb_autotoc_md2528}{}\doxysubsection{\texorpdfstring{reusify}{reusify}}\label{dir_1d3c6f960694dfa38cbe6ac5360433fb_autotoc_md2528}
...
This library was extracted from \href{http://npm.im/fastparallel}{\texttt{fastparallel}}.\hypertarget{dir_1d3c6f960694dfa38cbe6ac5360433fb_autotoc_md2529}{}\doxysubsection{\texorpdfstring{Example}{Example}}\label{dir_1d3c6f960694dfa38cbe6ac5360433fb_autotoc_md2529}
...
Also note how in the above examples, the code, that consumes an instance of {\ttfamily My\+Object}, reset the state to initial condition, just before storing it in the cache. That\textquotesingle{}s needed so that every subsequent request for an instance from the cache, could get a clean instance.\hypertarget{dir_1d3c6f960694dfa38cbe6ac5360433fb_autotoc_md2530}{}\doxysubsection{\texorpdfstring{Why}{Why}}\label{dir_1d3c6f960694dfa38cbe6ac5360433fb_autotoc_md2530}
It is faster because V8 doesn\textquotesingle{}t have to collect all the functions you create. On a short-\/lived benchmark, it is as fast as creating the nested function, but on a longer time frame it creates less pressure on the garbage collector.\hypertarget{dir_1d3c6f960694dfa38cbe6ac5360433fb_autotoc_md2531}{}\doxysubsection{\texorpdfstring{Other examples}{Other examples}}\label{dir_1d3c6f960694dfa38cbe6ac5360433fb_autotoc_md2531}
If you want to see some complex example, checkout \href{https://github.com/fastify/middie}{\texttt{middie}} and \href{https://github.com/mcollina/steed}{\texttt{steed}}.\hypertarget{dir_1d3c6f960694dfa38cbe6ac5360433fb_autotoc_md2532}{}\doxysubsection{\texorpdfstring{Acknowledgements}{Acknowledgements}}\label{dir_1d3c6f960694dfa38cbe6ac5360433fb_autotoc_md2532}
Thanks to \href{https://github.com/trevnorris}{\texttt{Trevor Norris}} for getting me down the rabbit hole of performance, and thanks to \href{http://github.com/mafintosh}{\texttt{Mathias Buss}} for suggesting me to share this trick.\hypertarget{dir_1d3c6f960694dfa38cbe6ac5360433fb_autotoc_md2533}{}\doxysubsection{\texorpdfstring{License}{License}}\label{dir_1d3c6f960694dfa38cbe6ac5360433fb_autotoc_md2533}
MIT 