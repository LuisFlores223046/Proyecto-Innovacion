...
\item 
directory \doxymbox{\hyperlink{dir_55bf9a7601814da83272d2d85293c3fe}{cjs}}
\item 
directory \doxymbox{\hyperlink{dir_a4fabd13bf5428b09b191d59bf9ade70}{esm}}
\item 
directory \doxymbox{\hyperlink{dir_7fe6b3280d55e6ceed5f1e0021b06a11}{golang}}
\item 
directory \doxymbox{\hyperlink{dir_e356d4fd6885897303ef0faa1188972a}{php}}
\item 
...
\hypertarget{dir_44933101ed218c243cf649975288178f_autotoc_md2411}{}\doxysubsection{\texorpdfstring{flatted}{flatted}}\label{dir_44933101ed218c243cf649975288178f_autotoc_md2411}
\href{https://www.npmjs.com/package/flatted}{\texttt{}} \href{https://coveralls.io/github/WebReflection/flatted?branch=main}{\texttt{}} \href{https://opensource.org/licenses/ISC}{\texttt{}} 
...
Available also for {\bfseries{\doxylink{dir_7fe6b3280d55e6ceed5f1e0021b06a11}{Go}}}.

\DoxyHorRuler{0}
\hypertarget{dir_44933101ed218c243cf649975288178f_autotoc_md2412}{}\doxysubsection{\texorpdfstring{Announcement 📣}{Announcement 📣}}\label{dir_44933101ed218c243cf649975288178f_autotoc_md2412}
...
\end{DoxyCode}
\hypertarget{dir_44933101ed218c243cf649975288178f_autotoc_md2413}{}\doxysubsection{\texorpdfstring{to\+JSON and from\+JSON}{to\+JSON and from\+JSON}}\label{dir_44933101ed218c243cf649975288178f_autotoc_md2413}
...
\end{DoxyCode}
\hypertarget{dir_44933101ed218c243cf649975288178f_autotoc_md2414}{}\doxysubsection{\texorpdfstring{Flatted VS JSON}{Flatted VS JSON}}\label{dir_44933101ed218c243cf649975288178f_autotoc_md2414}
...
Also please note this project serializes and deserializes only data compatible with JSON, so that sockets, or anything else with internal classes different from those allowed by JSON standard, won\textquotesingle{}t be serialized and unserialized as expected.\hypertarget{dir_44933101ed218c243cf649975288178f_autotoc_md2415}{}\doxysubsubsection{\texorpdfstring{New in V1:\+ Exact same JSON API}{New in V1:\+ Exact same JSON API}}\label{dir_44933101ed218c243cf649975288178f_autotoc_md2415}
...
\end{DoxyItemize}\hypertarget{dir_44933101ed218c243cf649975288178f_autotoc_md2416}{}\doxysubsubsection{\texorpdfstring{Compatibility}{Compatibility}}\label{dir_44933101ed218c243cf649975288178f_autotoc_md2416}
All ECMAScript engines compatible with {\ttfamily Map}, {\ttfamily Set}, {\ttfamily Object.\+keys}, and {\ttfamily Array.\+prototype.\+reduce} will work, even if polyfilled.\hypertarget{dir_44933101ed218c243cf649975288178f_autotoc_md2417}{}\doxysubsubsection{\texorpdfstring{How does it work ?}{How does it work ?}}\label{dir_44933101ed218c243cf649975288178f_autotoc_md2417}
