\doxysection{frontend/\+node\+\_\+modules/\+commander Directory Reference}
\hypertarget{dir_399a889f9da9f94bf9fc89a7ec8e43c4}{}\label{dir_399a889f9da9f94bf9fc89a7ec8e43c4}\index{frontend/node\_modules/commander Directory Reference@{frontend/node\_modules/commander Directory Reference}}


\doxysubsection{Detailed Description}
\hypertarget{dir_399a889f9da9f94bf9fc89a7ec8e43c4_autotoc_md743}{}\doxysubsection{\texorpdfstring{Commander.\+js}{Commander.\+js}}\label{dir_399a889f9da9f94bf9fc89a7ec8e43c4_autotoc_md743}
...
\begin{DoxyItemize}
\item Commander.jsCommander.\+js
\end{DoxyItemize}
\begin{DoxyItemize}
\item InstallationInstallation
\end{DoxyItemize}
\begin{DoxyItemize}
\item Declaring program variableDeclaring program variable
\end{DoxyItemize}
\begin{DoxyItemize}
\item OptionsOptions
\end{DoxyItemize}
\begin{DoxyItemize}
\item Common option types, boolean and valueCommon option types, boolean and value
\end{DoxyItemize}
\begin{DoxyItemize}
\item Default option valueDefault option value
\end{DoxyItemize}
\begin{DoxyItemize}
\item Other option types, negatable boolean and flag\texorpdfstring{$\vert$}{|}valueOther option types, negatable boolean and flag\texorpdfstring{$\vert$}{|}value
\end{DoxyItemize}
\begin{DoxyItemize}
\item Custom option processingCustom option processing
\end{DoxyItemize}
\begin{DoxyItemize}
\item Required optionRequired option
\end{DoxyItemize}
\begin{DoxyItemize}
\item Version optionVersion option
\end{DoxyItemize}
\begin{DoxyItemize}
\item CommandsCommands
\end{DoxyItemize}
\begin{DoxyItemize}
\item Specify the argument syntaxSpecify the argument syntax
\end{DoxyItemize}
\begin{DoxyItemize}
\item Action handler (sub)commandsAction handler (sub)commands
\end{DoxyItemize}
\begin{DoxyItemize}
\item Git-\/style executable (sub)commandsGit-\/style executable (sub)commands
\end{DoxyItemize}
\begin{DoxyItemize}
\item Automated -\/-\/helpAutomated --help
\end{DoxyItemize}
\begin{DoxyItemize}
\item Custom helpCustom help
\end{DoxyItemize}
\begin{DoxyItemize}
\item .usage and .name.usage and .name
\end{DoxyItemize}
\begin{DoxyItemize}
\item .output\+Help(cb).output\+Help(cb)
\end{DoxyItemize}
\begin{DoxyItemize}
\item .help\+Option(flags, description).help\+Option(flags, description)
\end{DoxyItemize}
\begin{DoxyItemize}
\item .help(cb).help(cb)
\end{DoxyItemize}
\begin{DoxyItemize}
\item Custom event listenersCustom event listeners
\end{DoxyItemize}
\begin{DoxyItemize}
\item Bits and piecesBits and pieces
\end{DoxyItemize}
\begin{DoxyItemize}
\item Avoiding option name clashesAvoiding option name clashes
\end{DoxyItemize}
\begin{DoxyItemize}
\item Type\+ScriptType\+Script
\end{DoxyItemize}
\begin{DoxyItemize}
\item Node options such as -\/-\/harmonyNode options such as --harmony
\end{DoxyItemize}
\begin{DoxyItemize}
\item Node debuggingNode debugging
\end{DoxyItemize}
\begin{DoxyItemize}
\item Override exit handlingOverride exit handling
\end{DoxyItemize}
\begin{DoxyItemize}
...
\end{DoxyItemize}
\begin{DoxyItemize}
\item Commander for enterpriseCommander for enterprise
\end{DoxyItemize}\hypertarget{dir_399a889f9da9f94bf9fc89a7ec8e43c4_autotoc_md744}{}\doxysubsection{\texorpdfstring{Installation}{Installation}}\label{dir_399a889f9da9f94bf9fc89a7ec8e43c4_autotoc_md744}

\begin{DoxyCode}{0}
\DoxyCodeLine{npm\ install\ commander}

\end{DoxyCode}
\hypertarget{dir_399a889f9da9f94bf9fc89a7ec8e43c4_autotoc_md745}{}\doxysubsection{\texorpdfstring{Declaring {\itshape program} variable}{Declaring {\itshape program} variable}}\label{dir_399a889f9da9f94bf9fc89a7ec8e43c4_autotoc_md745}
...
\end{DoxyCode}
\hypertarget{dir_399a889f9da9f94bf9fc89a7ec8e43c4_autotoc_md746}{}\doxysubsection{\texorpdfstring{Options}{Options}}\label{dir_399a889f9da9f94bf9fc89a7ec8e43c4_autotoc_md746}
...
See also optional new behaviour to avoid name clashesavoid name clashes.\hypertarget{dir_399a889f9da9f94bf9fc89a7ec8e43c4_autotoc_md747}{}\doxysubsubsection{\texorpdfstring{Common option types, boolean and value}{Common option types, boolean and value}}\label{dir_399a889f9da9f94bf9fc89a7ec8e43c4_autotoc_md747}
...
{\ttfamily program.\+parse(arguments)} processes the arguments, leaving any args not consumed by the options as the {\ttfamily program.\+args} array.\hypertarget{dir_399a889f9da9f94bf9fc89a7ec8e43c4_autotoc_md748}{}\doxysubsubsection{\texorpdfstring{Default option value}{Default option value}}\label{dir_399a889f9da9f94bf9fc89a7ec8e43c4_autotoc_md748}
...
\end{DoxyCode}
\hypertarget{dir_399a889f9da9f94bf9fc89a7ec8e43c4_autotoc_md749}{}\doxysubsubsection{\texorpdfstring{Other option types, negatable boolean and flag\texorpdfstring{$\vert$}{|}value}{Other option types, negatable boolean and flag\texorpdfstring{$\vert$}{|}value}}\label{dir_399a889f9da9f94bf9fc89a7ec8e43c4_autotoc_md749}
...
\end{DoxyCode}
\hypertarget{dir_399a889f9da9f94bf9fc89a7ec8e43c4_autotoc_md750}{}\doxysubsubsection{\texorpdfstring{Custom option processing}{Custom option processing}}\label{dir_399a889f9da9f94bf9fc89a7ec8e43c4_autotoc_md750}
...
\end{DoxyCode}
\hypertarget{dir_399a889f9da9f94bf9fc89a7ec8e43c4_autotoc_md751}{}\doxysubsubsection{\texorpdfstring{Required option}{Required option}}\label{dir_399a889f9da9f94bf9fc89a7ec8e43c4_autotoc_md751}
...
\end{DoxyCode}
\hypertarget{dir_399a889f9da9f94bf9fc89a7ec8e43c4_autotoc_md752}{}\doxysubsubsection{\texorpdfstring{Version option}{Version option}}\label{dir_399a889f9da9f94bf9fc89a7ec8e43c4_autotoc_md752}
...
\end{DoxyCode}
\hypertarget{dir_399a889f9da9f94bf9fc89a7ec8e43c4_autotoc_md753}{}\doxysubsection{\texorpdfstring{Commands}{Commands}}\label{dir_399a889f9da9f94bf9fc89a7ec8e43c4_autotoc_md753}
You can specify (sub)commands for your top-\/level command using {\ttfamily .command}. There are two ways these can be implemented:\+ using an action handler attached to the command, or as a separate executable file (described in more detail later). In the first parameter to {\ttfamily .command} you specify the command name and any command arguments. The arguments may be {\ttfamily \texorpdfstring{$<$}{<}required\texorpdfstring{$>$}{>}} or {\ttfamily \+[optional]\+}, and the last argument may also be {\ttfamily variadic...}.
...
\end{DoxyCode}
\hypertarget{dir_399a889f9da9f94bf9fc89a7ec8e43c4_autotoc_md754}{}\doxysubsubsection{\texorpdfstring{Specify the argument syntax}{Specify the argument syntax}}\label{dir_399a889f9da9f94bf9fc89a7ec8e43c4_autotoc_md754}
You use {\ttfamily .arguments} to specify the arguments for the top-\/level command, and for subcommands they are included in the {\ttfamily .command} call. Angled brackets (e.\+g. {\ttfamily \texorpdfstring{$<$}{<}required\texorpdfstring{$>$}{>}}) indicate required input. Square brackets (e.\+g. {\ttfamily \+[optional]\+}) indicate optional input.
...
The variadic argument is passed to the action handler as an array. (And this also applies to {\ttfamily program.\+args}.)\hypertarget{dir_399a889f9da9f94bf9fc89a7ec8e43c4_autotoc_md755}{}\doxysubsubsection{\texorpdfstring{Action handler (sub)commands}{Action handler (sub)commands}}\label{dir_399a889f9da9f94bf9fc89a7ec8e43c4_autotoc_md755}
...
Configuration options can be passed with the call to {\ttfamily .command()}. Specifying {\ttfamily true} for {\ttfamily opts.\+no\+Help} will remove the command from the generated help output.\hypertarget{dir_399a889f9da9f94bf9fc89a7ec8e43c4_autotoc_md756}{}\doxysubsubsection{\texorpdfstring{Git-\/style executable (sub)commands}{Git-\/style executable (sub)commands}}\label{dir_399a889f9da9f94bf9fc89a7ec8e43c4_autotoc_md756}
...
If the program is designed to be installed globally, make sure the executables have proper modes, like {\ttfamily 755}.\hypertarget{dir_399a889f9da9f94bf9fc89a7ec8e43c4_autotoc_md757}{}\doxysubsection{\texorpdfstring{Automated --help}{Automated --help}}\label{dir_399a889f9da9f94bf9fc89a7ec8e43c4_autotoc_md757}
...
\end{DoxyCode}
\hypertarget{dir_399a889f9da9f94bf9fc89a7ec8e43c4_autotoc_md758}{}\doxysubsubsection{\texorpdfstring{Custom help}{Custom help}}\label{dir_399a889f9da9f94bf9fc89a7ec8e43c4_autotoc_md758}
...
\end{DoxyCode}
\hypertarget{dir_399a889f9da9f94bf9fc89a7ec8e43c4_autotoc_md759}{}\doxysubsubsection{\texorpdfstring{.usage and .name}{.usage and .name}}\label{dir_399a889f9da9f94bf9fc89a7ec8e43c4_autotoc_md759}
...
\end{DoxyCode}
\hypertarget{dir_399a889f9da9f94bf9fc89a7ec8e43c4_autotoc_md760}{}\doxysubsubsection{\texorpdfstring{.output\+Help(cb)}{.output\+Help(cb)}}\label{dir_399a889f9da9f94bf9fc89a7ec8e43c4_autotoc_md760}
...
\end{DoxyCode}
\hypertarget{dir_399a889f9da9f94bf9fc89a7ec8e43c4_autotoc_md761}{}\doxysubsubsection{\texorpdfstring{.help\+Option(flags, description)}{.help\+Option(flags, description)}}\label{dir_399a889f9da9f94bf9fc89a7ec8e43c4_autotoc_md761}
...
\end{DoxyCode}
\hypertarget{dir_399a889f9da9f94bf9fc89a7ec8e43c4_autotoc_md762}{}\doxysubsubsection{\texorpdfstring{.help(cb)}{.help(cb)}}\label{dir_399a889f9da9f94bf9fc89a7ec8e43c4_autotoc_md762}
Output help information and exit immediately. Optional callback cb allows post-\/processing of help text before it is displayed.\hypertarget{dir_399a889f9da9f94bf9fc89a7ec8e43c4_autotoc_md763}{}\doxysubsection{\texorpdfstring{Custom event listeners}{Custom event listeners}}\label{dir_399a889f9da9f94bf9fc89a7ec8e43c4_autotoc_md763}
...
\end{DoxyCode}
\hypertarget{dir_399a889f9da9f94bf9fc89a7ec8e43c4_autotoc_md764}{}\doxysubsection{\texorpdfstring{Bits and pieces}{Bits and pieces}}\label{dir_399a889f9da9f94bf9fc89a7ec8e43c4_autotoc_md764}
\hypertarget{dir_399a889f9da9f94bf9fc89a7ec8e43c4_autotoc_md765}{}\doxysubsubsection{\texorpdfstring{Avoiding option name clashes}{Avoiding option name clashes}}\label{dir_399a889f9da9f94bf9fc89a7ec8e43c4_autotoc_md765}
...
\end{DoxyCode}
\hypertarget{dir_399a889f9da9f94bf9fc89a7ec8e43c4_autotoc_md766}{}\doxysubsubsection{\texorpdfstring{Type\+Script}{Type\+Script}}\label{dir_399a889f9da9f94bf9fc89a7ec8e43c4_autotoc_md766}
...
\end{DoxyCode}
\hypertarget{dir_399a889f9da9f94bf9fc89a7ec8e43c4_autotoc_md767}{}\doxysubsubsection{\texorpdfstring{Node options such as {\ttfamily -\/-\/harmony}}{Node options such as {\ttfamily -\/-\/harmony}}}\label{dir_399a889f9da9f94bf9fc89a7ec8e43c4_autotoc_md767}
...
\end{DoxyItemize}\hypertarget{dir_399a889f9da9f94bf9fc89a7ec8e43c4_autotoc_md768}{}\doxysubsubsection{\texorpdfstring{Node debugging}{Node debugging}}\label{dir_399a889f9da9f94bf9fc89a7ec8e43c4_autotoc_md768}
If you are using the node inspector for \href{https://nodejs.org/en/docs/guides/debugging-getting-started/}{\texttt{debugging}} git-\/style executable (sub)commands using {\ttfamily node -\/-\/inspect} et al, the inspector port is incremented by 1 for the spawned subcommand.\hypertarget{dir_399a889f9da9f94bf9fc89a7ec8e43c4_autotoc_md769}{}\doxysubsubsection{\texorpdfstring{Override exit handling}{Override exit handling}}\label{dir_399a889f9da9f94bf9fc89a7ec8e43c4_autotoc_md769}
...
\end{DoxyCode}
\hypertarget{dir_399a889f9da9f94bf9fc89a7ec8e43c4_autotoc_md770}{}\doxysubsection{\texorpdfstring{Examples}{Examples}}\label{dir_399a889f9da9f94bf9fc89a7ec8e43c4_autotoc_md770}
...
More Demos can be found in the \href{https://github.com/tj/commander.js/tree/master/examples}{\texttt{examples}} directory.\hypertarget{dir_399a889f9da9f94bf9fc89a7ec8e43c4_autotoc_md771}{}\doxysubsection{\texorpdfstring{License}{License}}\label{dir_399a889f9da9f94bf9fc89a7ec8e43c4_autotoc_md771}
\href{https://github.com/tj/commander.js/blob/master/LICENSE}{\texttt{MIT}}\hypertarget{dir_399a889f9da9f94bf9fc89a7ec8e43c4_autotoc_md772}{}\doxysubsection{\texorpdfstring{Support}{Support}}\label{dir_399a889f9da9f94bf9fc89a7ec8e43c4_autotoc_md772}
...
The main forum for free and community support is the project \href{https://github.com/tj/commander.js/issues}{\texttt{Issues}} on Git\+Hub.\hypertarget{dir_399a889f9da9f94bf9fc89a7ec8e43c4_autotoc_md773}{}\doxysubsubsection{\texorpdfstring{Commander for enterprise}{Commander for enterprise}}\label{dir_399a889f9da9f94bf9fc89a7ec8e43c4_autotoc_md773}
