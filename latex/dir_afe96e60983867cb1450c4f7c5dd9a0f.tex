\doxysection{frontend/\+node\+\_\+modules/\+acorn Directory Reference}
\hypertarget{dir_afe96e60983867cb1450c4f7c5dd9a0f}{}\label{dir_afe96e60983867cb1450c4f7c5dd9a0f}\index{frontend/node\_modules/acorn Directory Reference@{frontend/node\_modules/acorn Directory Reference}}
\doxysubsubsection*{Directories}
\begin{DoxyCompactItemize}
\item 
directory \doxymbox{\hyperlink{dir_342de7ecee27520383b91ccfcb735411}{dist}}
\end{DoxyCompactItemize}


\doxysubsection{Detailed Description}
\hypertarget{dir_afe96e60983867cb1450c4f7c5dd9a0f_autotoc_md818}{}\doxysubsection{\texorpdfstring{Acorn}{Acorn}}\label{dir_afe96e60983867cb1450c4f7c5dd9a0f_autotoc_md818}
A tiny, fast Java\+Script parser written in Java\+Script.\hypertarget{dir_afe96e60983867cb1450c4f7c5dd9a0f_autotoc_md819}{}\doxysubsection{\texorpdfstring{Community}{Community}}\label{dir_afe96e60983867cb1450c4f7c5dd9a0f_autotoc_md819}
...
You are welcome to \href{https://github.com/acornjs/acorn/issues}{\texttt{report bugs}} or create pull requests on \href{https://github.com/acornjs/acorn}{\texttt{github}}.\hypertarget{dir_afe96e60983867cb1450c4f7c5dd9a0f_autotoc_md820}{}\doxysubsection{\texorpdfstring{Installation}{Installation}}\label{dir_afe96e60983867cb1450c4f7c5dd9a0f_autotoc_md820}
...
\end{DoxyCode}
 \hypertarget{dir_afe96e60983867cb1450c4f7c5dd9a0f_autotoc_md821}{}\doxysubsection{\texorpdfstring{Importing acorn}{Importing acorn}}\label{dir_afe96e60983867cb1450c4f7c5dd9a0f_autotoc_md821}
ESM as well as Common\+JS is supported for all 3:\+ {\ttfamily acorn}, {\ttfamily acorn-\/walk} and {\ttfamily acorn-\/loose}.

ESM example for {\ttfamily acorn}:\+
...
Common\+JS example for {\ttfamily acorn}:\+
...
ESM is preferred, as it allows better editor auto-\/completions by offering Type\+Script support. For this reason, following examples will use ESM imports.\hypertarget{dir_afe96e60983867cb1450c4f7c5dd9a0f_autotoc_md822}{}\doxysubsection{\texorpdfstring{Interface}{Interface}}\label{dir_afe96e60983867cb1450c4f7c5dd9a0f_autotoc_md822}
...
\item {\bfseries{source\+Type}}:\+ Indicate the mode the code should be parsed in. Can be either {\ttfamily "{}script"{}}, {\ttfamily "{}module"{}} or {\ttfamily "{}commonjs"{}}. This influences global strict mode and parsing of {\ttfamily import} and {\ttfamily export} declarations.

{\bfseries{NOTE}}:\+ If set to {\ttfamily "{}module"{}}, then static {\ttfamily import} /\+ {\ttfamily export} syntax will be valid, even if {\ttfamily ecma\+Version} is less than 6. If set to {\ttfamily "{}commonjs"{}}, it is the same as {\ttfamily "{}script"{}} except that the top-\/level scope behaves like a function.
...
\item {\bfseries{allow\+Await\+Outside\+Function}}:\+ If {\ttfamily false}, {\ttfamily await} expressions can only appear inside {\ttfamily async} functions. Defaults to {\ttfamily true} in modules for {\ttfamily ecma\+Version} 2022 and later, {\ttfamily false} for lower versions. Setting this option to {\ttfamily true} allows to have top-\/level {\ttfamily await} expressions. They are still not allowed in non-\/{\ttfamily async} functions, though. Setting this option to {\ttfamily true} is not allowed when {\ttfamily source\+Type:\+ "{}commonjs"{}}.
...
{\bfseries{get\+Line\+Info}}{\ttfamily (input, offset)} can be used to get a {\ttfamily \{line, column\}} object for a given program string and offset.\hypertarget{dir_afe96e60983867cb1450c4f7c5dd9a0f_autotoc_md823}{}\doxysubsubsection{\texorpdfstring{The {\ttfamily Parser} class}{The {\ttfamily Parser} class}}\label{dir_afe96e60983867cb1450c4f7c5dd9a0f_autotoc_md823}
...
The {\ttfamily extend} method takes any number of plugin values, and returns a new {\ttfamily Parser} class that includes the extra parser logic provided by the plugins.\hypertarget{dir_afe96e60983867cb1450c4f7c5dd9a0f_autotoc_md824}{}\doxysubsection{\texorpdfstring{Command line interface}{Command line interface}}\label{dir_afe96e60983867cb1450c4f7c5dd9a0f_autotoc_md824}
...
The utility spits out the syntax tree as JSON data.\hypertarget{dir_afe96e60983867cb1450c4f7c5dd9a0f_autotoc_md825}{}\doxysubsection{\texorpdfstring{Existing plugins}{Existing plugins}}\label{dir_afe96e60983867cb1450c4f7c5dd9a0f_autotoc_md825}
