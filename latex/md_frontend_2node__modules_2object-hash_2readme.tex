\chapter{object-\/hash }
\hypertarget{md_frontend_2node__modules_2object-hash_2readme}{}\label{md_frontend_2node__modules_2object-hash_2readme}\index{object-\/hash@{object-\/hash}}
\label{md_frontend_2node__modules_2object-hash_2readme_autotoc_md1985}%
\Hypertarget{md_frontend_2node__modules_2object-hash_2readme_autotoc_md1985}%
...
\end{DoxyCode}
\hypertarget{md_frontend_2node__modules_2object-hash_2readme_autotoc_md1986}{}\doxysection{\texorpdfstring{Versioning Disclaimer}{Versioning Disclaimer}}\label{md_frontend_2node__modules_2object-hash_2readme_autotoc_md1986}
...
For more information, see \href{https://github.com/puleos/object-hash/issues/30}{\texttt{this discussion}}.\hypertarget{md_frontend_2node__modules_2object-hash_2readme_autotoc_md1987}{}\doxysection{\texorpdfstring{hash(value, options)}{hash(value, options)}}\label{md_frontend_2node__modules_2object-hash_2readme_autotoc_md1987}
...
\item {\ttfamily unordered\+Sets} \{true\texorpdfstring{$\vert$}{|}false\} Sort {\ttfamily Set} and {\ttfamily Map} instances before hashing, i.\+e. make {\ttfamily hash(new Set(\+[1, 2]\+)) == hash(new Set(\+[2, 1]\+))} return {\ttfamily true}. default:\+ true
...
\end{DoxyItemize}\hypertarget{md_frontend_2node__modules_2object-hash_2readme_autotoc_md1988}{}\doxysection{\texorpdfstring{hash.\+sha1(value)}{hash.\+sha1(value)}}\label{md_frontend_2node__modules_2object-hash_2readme_autotoc_md1988}
...
{\itshape Sugar method, equivalent to} {\ttfamily hash(value, \{algorithm:\+ \textquotesingle{}sha1\textquotesingle{}\})}\hypertarget{md_frontend_2node__modules_2object-hash_2readme_autotoc_md1989}{}\doxysection{\texorpdfstring{hash.\+keys(value)}{hash.\+keys(value)}}\label{md_frontend_2node__modules_2object-hash_2readme_autotoc_md1989}
Hash object keys using the sha1 algorithm, values ignored.

{\itshape Sugar method, equivalent to} {\ttfamily hash(value, \{exclude\+Values:\+ true\})}\hypertarget{md_frontend_2node__modules_2object-hash_2readme_autotoc_md1990}{}\doxysection{\texorpdfstring{hash.\+MD5(value)}{hash.\+MD5(value)}}\label{md_frontend_2node__modules_2object-hash_2readme_autotoc_md1990}
...
{\itshape Sugar method, equivalent to} {\ttfamily hash(value, \{algorithm:\+ \textquotesingle{}md5\textquotesingle{}\})}\hypertarget{md_frontend_2node__modules_2object-hash_2readme_autotoc_md1991}{}\doxysection{\texorpdfstring{hash.\+keys\+MD5(value)}{hash.\+keys\+MD5(value)}}\label{md_frontend_2node__modules_2object-hash_2readme_autotoc_md1991}
Hash object keys using the md5 algorithm, values ignored.

Note that the MD5 algorithm is not considered secure, and a stronger algorithm should be used if a cryptographical hash is desired.

{\itshape Sugar method, equivalent to} {\ttfamily hash(value, \{algorithm:\+ \textquotesingle{}md5\textquotesingle{}, exclude\+Values:\+ true\})}\hypertarget{md_frontend_2node__modules_2object-hash_2readme_autotoc_md1992}{}\doxysection{\texorpdfstring{hash.\+write\+To\+Stream(value, \+[options,]\+ stream)}{hash.\+write\+To\+Stream(value, \+[options,]\+ stream)}}\label{md_frontend_2node__modules_2object-hash_2readme_autotoc_md1992}
...
\end{DoxyCode}
\hypertarget{md_frontend_2node__modules_2object-hash_2readme_autotoc_md1993}{}\doxysection{\texorpdfstring{Installation}{Installation}}\label{md_frontend_2node__modules_2object-hash_2readme_autotoc_md1993}
node:\+
...
\end{DoxyCode}
\hypertarget{md_frontend_2node__modules_2object-hash_2readme_autotoc_md1994}{}\doxysection{\texorpdfstring{Example usage}{Example usage}}\label{md_frontend_2node__modules_2object-hash_2readme_autotoc_md1994}
...
\end{DoxyCode}
\hypertarget{md_frontend_2node__modules_2object-hash_2readme_autotoc_md1995}{}\doxysection{\texorpdfstring{Legacy Browser Support}{Legacy Browser Support}}\label{md_frontend_2node__modules_2object-hash_2readme_autotoc_md1995}
IE \texorpdfstring{$<$}{<}= 8 and Opera \texorpdfstring{$<$}{<}= 11 support dropped in version 0.\+3.\+0. If you require legacy browser support you must either use an ES5 shim or use version 0.\+2.\+5 of this module.\hypertarget{md_frontend_2node__modules_2object-hash_2readme_autotoc_md1996}{}\doxysection{\texorpdfstring{Development}{Development}}\label{md_frontend_2node__modules_2object-hash_2readme_autotoc_md1996}
...
\end{DoxyCode}
\hypertarget{md_frontend_2node__modules_2object-hash_2readme_autotoc_md1997}{}\doxysection{\texorpdfstring{Node Docker Wrapper}{Node Docker Wrapper}}\label{md_frontend_2node__modules_2object-hash_2readme_autotoc_md1997}
If you want to stand this up in a docker container, you should take at look at the \href{https://github.com/bean5/node-object-hash}{\texttt{}} project.\hypertarget{md_frontend_2node__modules_2object-hash_2readme_autotoc_md1998}{}\doxysubsection{\texorpdfstring{gulp tasks}{gulp tasks}}\label{md_frontend_2node__modules_2object-hash_2readme_autotoc_md1998}
...
\end{DoxyItemize}\hypertarget{md_frontend_2node__modules_2object-hash_2readme_autotoc_md1999}{}\doxysection{\texorpdfstring{License}{License}}\label{md_frontend_2node__modules_2object-hash_2readme_autotoc_md1999}
MIT\hypertarget{md_frontend_2node__modules_2object-hash_2readme_autotoc_md2000}{}\doxysection{\texorpdfstring{Changelog}{Changelog}}\label{md_frontend_2node__modules_2object-hash_2readme_autotoc_md2000}
\hypertarget{md_frontend_2node__modules_2object-hash_2readme_autotoc_md2001}{}\doxysubsection{\texorpdfstring{v2.\+0.\+0}{v2.\+0.\+0}}\label{md_frontend_2node__modules_2object-hash_2readme_autotoc_md2001}
