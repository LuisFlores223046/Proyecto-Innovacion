\doxysection{frontend/\+node\+\_\+modules/\+sucrase Directory Reference}
\hypertarget{dir_0224b44e9d69279ae30639746634cd3f}{}\label{dir_0224b44e9d69279ae30639746634cd3f}\index{frontend/node\_modules/sucrase Directory Reference@{frontend/node\_modules/sucrase Directory Reference}}
\doxysubsubsection*{Directories}
\begin{DoxyCompactItemize}
\item 
directory \doxymbox{\hyperlink{dir_6ad2d9ee4d048188c816a2a4de01b53a}{dist}}
\item 
directory \doxymbox{\hyperlink{dir_5fb0d181796c08bdec2a17379a107065}{register}}
\item 
directory \doxymbox{\hyperlink{dir_f0c9184e2b5a9ee13cc17f6b012ecbf6}{ts-\/node-\/plugin}}
\end{DoxyCompactItemize}


\doxysubsection{Detailed Description}
\hypertarget{dir_0224b44e9d69279ae30639746634cd3f_autotoc_md2563}{}\doxysubsection{\texorpdfstring{Sucrase}{Sucrase}}\label{dir_0224b44e9d69279ae30639746634cd3f_autotoc_md2563}
\href{https://github.com/alangpierce/sucrase/actions}{\texttt{}} \href{https://www.npmjs.com/package/sucrase}{\texttt{}} \href{https://packagephobia.now.sh/result?p=sucrase}{\texttt{}} \+[]\+(LICENSE) \href{https://gitter.im/sucrasejs/Lobby}{\texttt{}}\hypertarget{dir_0224b44e9d69279ae30639746634cd3f_autotoc_md2564}{}\doxysubsection{\texorpdfstring{\href{https://sucrase.io}{\texttt{Try it out}}}{\href{https://sucrase.io}{\texttt{Try it out}}}}\label{dir_0224b44e9d69279ae30639746634cd3f_autotoc_md2564}
\hypertarget{dir_0224b44e9d69279ae30639746634cd3f_autotoc_md2565}{}\doxysubsection{\texorpdfstring{Quick usage}{Quick usage}}\label{dir_0224b44e9d69279ae30639746634cd3f_autotoc_md2565}
...
\end{DoxyCode}
\hypertarget{dir_0224b44e9d69279ae30639746634cd3f_autotoc_md2566}{}\doxysubsection{\texorpdfstring{Project overview}{Project overview}}\label{dir_0224b44e9d69279ae30639746634cd3f_autotoc_md2566}
...
Details:\+ Measured on July 2022. Tools run in single-\/threaded mode without warm-\/up. See the \href{https://github.com/alangpierce/sucrase/blob/main/benchmark/benchmark.ts}{\texttt{benchmark code}} for methodology and caveats.\hypertarget{dir_0224b44e9d69279ae30639746634cd3f_autotoc_md2567}{}\doxysubsection{\texorpdfstring{Transforms}{Transforms}}\label{dir_0224b44e9d69279ae30639746634cd3f_autotoc_md2567}
...
\end{DoxyItemize}\hypertarget{dir_0224b44e9d69279ae30639746634cd3f_autotoc_md2569}{}\doxysubsubsection{\texorpdfstring{JSX Options}{JSX Options}}\label{dir_0224b44e9d69279ae30639746634cd3f_autotoc_md2569}
...
\end{DoxyItemize}\hypertarget{dir_0224b44e9d69279ae30639746634cd3f_autotoc_md2570}{}\doxysubsubsection{\texorpdfstring{Legacy Common\+JS interop}{Legacy Common\+JS interop}}\label{dir_0224b44e9d69279ae30639746634cd3f_autotoc_md2570}
Two legacy modes can be used with the {\ttfamily imports} transform:\+


\begin{DoxyItemize}
\item {\bfseries{enable\+Legacy\+Type\+Script\+Module\+Interop}}:\+ Use the default Type\+Script approach to Common\+JS interop instead of assuming that Type\+Script\textquotesingle{}s {\ttfamily -\/-\/es\+Module\+Interop} flag is enabled. For example, if a CJS module exports a function, legacy Type\+Script interop requires you to write {\ttfamily import \texorpdfstring{$\ast$}{*} as add from \textquotesingle{}./\+add\textquotesingle{};}, while Babel, Webpack, Node.\+js, and Type\+Script with {\ttfamily -\/-\/es\+Module\+Interop} require you to write {\ttfamily import add from \textquotesingle{}./\+add\textquotesingle{};}. As mentioned in the \href{https://www.typescriptlang.org/docs/handbook/release-notes/typescript-2-7.html\#support-for-import-d-from-cjs-form-commonjs-modules-with---esmoduleinterop}{\texttt{docs}}, the Type\+Script team recommends you always use {\ttfamily -\/-\/es\+Module\+Interop}.
\item {\bfseries{enable\+Legacy\+Babel5\+Module\+Interop}}:\+ Use the Babel 5 approach to Common\+JS interop, so that you can run {\ttfamily require(\textquotesingle{}./\+\+My\+Module\textquotesingle{})} instead of {\ttfamily require(\textquotesingle{}./\+\+My\+Module\textquotesingle{}).default}. Analogous to \href{https://github.com/59naga/babel-plugin-add-module-exports}{\texttt{babel-\/plugin-\/add-\/module-\/exports}}.
\end{DoxyItemize}\hypertarget{dir_0224b44e9d69279ae30639746634cd3f_autotoc_md2571}{}\doxysubsection{\texorpdfstring{Usage}{Usage}}\label{dir_0224b44e9d69279ae30639746634cd3f_autotoc_md2571}
\hypertarget{dir_0224b44e9d69279ae30639746634cd3f_autotoc_md2572}{}\doxysubsubsection{\texorpdfstring{Tool integrations}{Tool integrations}}\label{dir_0224b44e9d69279ae30639746634cd3f_autotoc_md2572}
...
\end{DoxyItemize}\hypertarget{dir_0224b44e9d69279ae30639746634cd3f_autotoc_md2573}{}\doxysubsubsection{\texorpdfstring{Usage in Node}{Usage in Node}}\label{dir_0224b44e9d69279ae30639746634cd3f_autotoc_md2573}
...
Options can be passed to the require hook via a {\ttfamily SUCRASE\+\_\+\+OPTIONS} environment variable holding a JSON string of options.\hypertarget{dir_0224b44e9d69279ae30639746634cd3f_autotoc_md2574}{}\doxysubsubsection{\texorpdfstring{Compiling a project to JS}{Compiling a project to JS}}\label{dir_0224b44e9d69279ae30639746634cd3f_autotoc_md2574}
...
\end{DoxyCode}
\hypertarget{dir_0224b44e9d69279ae30639746634cd3f_autotoc_md2575}{}\doxysubsubsection{\texorpdfstring{Usage from code}{Usage from code}}\label{dir_0224b44e9d69279ae30639746634cd3f_autotoc_md2575}
...
\end{DoxyCode}
\hypertarget{dir_0224b44e9d69279ae30639746634cd3f_autotoc_md2576}{}\doxysubsection{\texorpdfstring{What Sucrase is not}{What Sucrase is not}}\label{dir_0224b44e9d69279ae30639746634cd3f_autotoc_md2576}
...
See the Project Vision document for more details on the philosophy behind Sucrase.\hypertarget{dir_0224b44e9d69279ae30639746634cd3f_autotoc_md2577}{}\doxysubsection{\texorpdfstring{Motivation}{Motivation}}\label{dir_0224b44e9d69279ae30639746634cd3f_autotoc_md2577}
...
Because Sucrase works on a lower level and uses a custom parser for its use case, it is much faster than Babel.\hypertarget{dir_0224b44e9d69279ae30639746634cd3f_autotoc_md2578}{}\doxysubsection{\texorpdfstring{Contributing}{Contributing}}\label{dir_0224b44e9d69279ae30639746634cd3f_autotoc_md2578}
Contributions are welcome, whether they be bug reports, PRs, docs, tests, or anything else! Please take a look through the Contributing Guide to learn how to get started.\hypertarget{dir_0224b44e9d69279ae30639746634cd3f_autotoc_md2579}{}\doxysubsection{\texorpdfstring{License and attribution}{License and attribution}}\label{dir_0224b44e9d69279ae30639746634cd3f_autotoc_md2579}
Sucrase is MIT-\/licensed. A large part of Sucrase is based on a fork of the \href{https://github.com/babel/babel/tree/main/packages/babel-parser}{\texttt{Babel parser}}, which is also MIT-\/licensed.\hypertarget{dir_0224b44e9d69279ae30639746634cd3f_autotoc_md2580}{}\doxysubsection{\texorpdfstring{Why the name?}{Why the name?}}\label{dir_0224b44e9d69279ae30639746634cd3f_autotoc_md2580}
