\doxysection{frontend/\+node\+\_\+modules/\+arg Directory Reference}
\hypertarget{dir_20d680eb5b4bcf60e533327631901644}{}\label{dir_20d680eb5b4bcf60e533327631901644}\index{frontend/node\_modules/arg Directory Reference@{frontend/node\_modules/arg Directory Reference}}


\doxysubsection{Detailed Description}
\hypertarget{dir_20d680eb5b4bcf60e533327631901644_autotoc_md154}{}\doxysubsection{\texorpdfstring{Arg}{Arg}}\label{dir_20d680eb5b4bcf60e533327631901644_autotoc_md154}
{\ttfamily arg} is an unopinionated, no-\/frills CLI argument parser.\hypertarget{dir_20d680eb5b4bcf60e533327631901644_autotoc_md155}{}\doxysubsection{\texorpdfstring{Installation}{Installation}}\label{dir_20d680eb5b4bcf60e533327631901644_autotoc_md155}

\begin{DoxyCode}{0}
\DoxyCodeLine{npm\ install\ arg}

\end{DoxyCode}
\hypertarget{dir_20d680eb5b4bcf60e533327631901644_autotoc_md156}{}\doxysubsection{\texorpdfstring{Usage}{Usage}}\label{dir_20d680eb5b4bcf60e533327631901644_autotoc_md156}
...
\DoxyCodeLine{\ \ \ \ spec,}
\DoxyCodeLine{\ \ \ \ (options\ =\ \{\ permissive:\ false,\ argv:\ process.argv.slice(2)\ \})}
\DoxyCodeLine{);}
...
The values for each key=\texorpdfstring{$>$}{>}value pair is either a type (function or \+[function]\+) or a string (indicating an alias).
...
This means the built-\/in {\ttfamily String}, {\ttfamily Number}, and {\ttfamily Boolean} type constructors "{}just work"{} as type functions.

Note that {\ttfamily Boolean} and {\ttfamily \+[Boolean]\+} have special treatment -\/ an option argument is {\itshape not} consumed or passed, but instead {\ttfamily true} is returned. These options are called "{}flags"{}.
...
As well, {\ttfamily arg} supplies a helper argument handler called {\ttfamily arg.\+COUNT}, which equivalent to a {\ttfamily \+[Boolean]\+} argument\textquotesingle{}s {\ttfamily .length} property -\/ effectively counting the number of times the boolean flag, denoted by the key, is passed on the command line.. For example, this is how you could implement {\ttfamily ssh}\textquotesingle{}s multiple levels of verbosity ({\ttfamily -\/vvvv} being the most verbose).
...
\end{DoxyCode}
\hypertarget{dir_20d680eb5b4bcf60e533327631901644_autotoc_md157}{}\doxysubsubsection{\texorpdfstring{Options}{Options}}\label{dir_20d680eb5b4bcf60e533327631901644_autotoc_md157}
If a second parameter is specified and is an object, it specifies parsing options to modify the behavior of {\ttfamily arg()}.\hypertarget{dir_20d680eb5b4bcf60e533327631901644_autotoc_md158}{}\doxysubsubsubsection{\texorpdfstring{{\ttfamily argv}}{{\ttfamily argv}}}\label{dir_20d680eb5b4bcf60e533327631901644_autotoc_md158}
...
\end{DoxyCode}
\hypertarget{dir_20d680eb5b4bcf60e533327631901644_autotoc_md159}{}\doxysubsubsubsection{\texorpdfstring{{\ttfamily permissive}}{{\ttfamily permissive}}}\label{dir_20d680eb5b4bcf60e533327631901644_autotoc_md159}
...
\end{DoxyCode}
\hypertarget{dir_20d680eb5b4bcf60e533327631901644_autotoc_md160}{}\doxysubsubsubsection{\texorpdfstring{{\ttfamily stop\+At\+Positional}}{{\ttfamily stop\+At\+Positional}}}\label{dir_20d680eb5b4bcf60e533327631901644_autotoc_md160}
...
\end{DoxyCode}
\hypertarget{dir_20d680eb5b4bcf60e533327631901644_autotoc_md161}{}\doxysubsubsection{\texorpdfstring{Errors}{Errors}}\label{dir_20d680eb5b4bcf60e533327631901644_autotoc_md161}
Some errors that {\ttfamily arg} throws provide a {\ttfamily .code} property in order to aid in recovering from user error, or to differentiate between user error and developer error (bug).\hypertarget{dir_20d680eb5b4bcf60e533327631901644_autotoc_md162}{}\doxysubsubsubsubsection{\texorpdfstring{ARG\+\_\+\+UNKNOWN\+\_\+\+OPTION}{ARG\+\_\+\+UNKNOWN\+\_\+\+OPTION}}\label{dir_20d680eb5b4bcf60e533327631901644_autotoc_md162}
...
\end{DoxyCode}
\hypertarget{dir_20d680eb5b4bcf60e533327631901644_autotoc_md163}{}\doxysubsection{\texorpdfstring{FAQ}{FAQ}}\label{dir_20d680eb5b4bcf60e533327631901644_autotoc_md163}
A few questions and answers that have been asked before:\+\hypertarget{dir_20d680eb5b4bcf60e533327631901644_autotoc_md164}{}\doxysubsubsubsection{\texorpdfstring{How do I require an argument with {\ttfamily arg}?}{How do I require an argument with {\ttfamily arg}?}}\label{dir_20d680eb5b4bcf60e533327631901644_autotoc_md164}
Do the assertion yourself, such as:\+


\begin{DoxyCode}{0}
\DoxyCodeLine{const\ args\ =\ arg(\{\ '-\/-\/name':\ String\ \});}
\DoxyCodeLine{}
\DoxyCodeLine{if\ (!args['-\/-\/name'])\ throw\ new\ Error('missing\ required\ argument:\ -\/-\/name');}

\end{DoxyCode}
\hypertarget{dir_20d680eb5b4bcf60e533327631901644_autotoc_md165}{}\doxysubsection{\texorpdfstring{License}{License}}\label{dir_20d680eb5b4bcf60e533327631901644_autotoc_md165}
Released under the \doxysectlink{md_frontend_2node__modules_2arg_2LICENSE}{MIT License}{0}. 